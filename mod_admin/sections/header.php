                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="col-md-8 text-center">
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" name="tdo" value="1" class="form-check-input" <?php echo $dni;?>> DNI
                                                    <input type="radio" name="tdo" value="2" class="form-check-input" <?php echo $pasaporte;?>> PASAPORTE
                                                    <input type="radio" name="tdo" value="3" class="form-check-input" <?php echo $carnetExtrajro;?>> CARNET DE EXTRANJERO
                                                </div>
                                            </div>
                                            <div class="col-md-8 text-center">
