<?php
    ...
    if(empty($_SESSION['codUsu'])){
    ...
    }elseif(empty($_POST["tdo"])){
        $errors[]="Ingrese su tipo de documento";
    }elseif(
        !empty($_POST["nom"]) &&
        !empty($_POST["app"]) &&
        !empty($_POST["apm"]) &&
        ...
        $sql = "UPDATE usuario SET nomUsu='".$nom."',appUsu='".$app."',apmUsu='".$apm."',docUsu='".$doc."',celUsu='".$cel."',sexUsu='".$sex."',tdoUsu='".$tdo."' WHERE codUsu='".$id."'";
