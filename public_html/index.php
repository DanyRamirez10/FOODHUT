...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#book-table">Realizar pedido</a>
                </li>
            </ul>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#blog">Menú<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#testmonial">Chefs</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container-fluid has-bg-overlay text-center text-light has-height-lg middle-items" id="book-table">
        <div class="pad">
            <h2 class="section-title mb-5">REALIZA TU PEDIDO AQUI</h2>
            <div class=" mb-5 div_center">
                <div class="col-sm-6  col-xs-12 my-2">
                    <input type="nombre" id="booktable" class="form-control form-control-lg custom-form-control" placeholder="NOMBRE COMPLETO">
                </div>
                <div class="col-sm-6  col-xs-12 my-2">
                    <input type="tel"  id="booktable" class="form-control form-control-lg custom-form-control" placeholder="DNI">
                </div>
                <div class="col-sm-6  col-xs-12 my-2">
                    <input type="text"  id="booktable" class="form-control form-control-lg custom-form-control" placeholder="DIRECCION">
                </div>
                <div class="col-sm-6  col-xs-12 my-2">
                    <input type="email" id="booktable" class="form-control form-control-lg custom-form-control" placeholder="EMAIL">
                </div>
                <div class="col-sm-6  col-xs-12 my-2">
                    <input type="number" id="booktable" class="form-control form-control-lg custom-form-control" placeholder="CANTIDAD DE PEDIDOS" max="20" min="0">
                </div>
                <div class="col-sm-6  col-xs-12 my-2">
                    <input type="text"  id="booktable" class="form-control form-control-lg custom-form-control" placeholder="TIPO" disabled>
                </div>
                <div class="col-sm-6  col-xs-12 my-2">
                    <input type="text"  id="booktable" class="form-control form-control-lg custom-form-control" placeholder="MENU" disabled>
                </div>
                <div class="col-sm-6  col-xs-12 my-2">
                    <input type="date" id="booktable" class="form-control form-control-lg custom-form-control" placeholder="12/12/12">
                </div>
            </div>
            <a href="#" class="btn btn-lg btn-primary" id="rounded-btn">Pedir Ya!</a>
        </div>
    </div>
    ...
    <div id="testmonial" class="container-fluid wow fadeIn bg-dark text-light has-height-lg middle-items">
        <h2 class="section-title my-5 text-center">CHEFS</h2>
